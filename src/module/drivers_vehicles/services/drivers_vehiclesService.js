...
export const drivers_vehiclesService = {
    async save( data , header_param = null) {
        ...
        try{
            const url_request = 'api/v1/drivers_vehicles_app/'
            ...
            response.result.message = "Responsed successfully in drivers_vehicles service."
    ...
    async update( id, data , header_param = null) {
        ...
        try{
            const url_request = 'api/v1/drivers_vehicles_app/' + id
    ...
    async remove( id = null , header_param = null) {
        ...
        try{
            ...
            response.result.message = (id == null) 
                                        ? `Deleted successfully in drivers_vehicles module with id ${id}`
                                        : "Deleted successfully in drivers_vehicles module"
            response.error = false
        }catch( error ){
            response.result.http_status = error.http_status ?? 500
            response.result.message = error.message ?? 'Unexpected error'
