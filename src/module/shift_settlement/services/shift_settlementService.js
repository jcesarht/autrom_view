...
export const shift_settlementService = {
    async save( data , header_param = null) {
        ...
        try{
            ...
            response.result.message = "Responsed successfully in shift_settlement service."
    ...
    async update( id, data , header_param = null) {
        ...
        try{
            const url_request = 'api/v1/shift_settlement_app/' + id
    ...
    async remove( id = null , header_param = null) {
        ...
        try{
            ...
            response.result.message = (id == null) 
                                        ? `Deleted successfully in shift_settlement module with id ${id}`
                                        : "Deleted successfully in shift_settlement module"
            response.error = false
        }catch( error ){
            response.result.http_status = error.http_status ?? 500
            response.result.message = error.message ?? 'Unexpected error'
