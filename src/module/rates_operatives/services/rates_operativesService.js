...
export const rates_operativesService = {
    async save( data , header_param = null) {
        ...
        try{
            const url_request = 'api/v1/rates_operatives_app/'
            ...
            response.result.message = "Responsed successfully in rates_operatives service."
    ...
    async update( id, data , header_param = null) {
        ...
        try{
            const url_request = 'api/v1/rates_operatives_app/' + id
    ...
    async remove( id = null , header_param = null) {
        ...
        try{
            ...
            response.result.message = (id == null) 
                                        ? `Deleted successfully in rates_operatives module with id ${id}`
                                        : "Deleted successfully in rates_operatives module"
            response.error = false
        }catch( error ){
            response.result.http_status = error.http_status ?? 500
            response.result.message = error.message ?? 'Unexpected error'
