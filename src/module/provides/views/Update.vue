<script setup>
    ...
    const { update, error, message } = useProvides()
            ...
            <div class="w-12/12">
                ...
                <div>
                     <UIInputText 
                        ...
                        :value="props.dataForUpdate.pro_dni"
                        required="true"
                    />
                </div>
                <div>
                     <UIInputText 
                        ...
                        field="Tipo de DNI"
                        :ref="element => inputs.push(element)"
                        :value="props.dataForUpdate.pro_type_dni"
                        required="false"
                    />
                </div>
                <div>
                     <UIInputText 
                        ...
                        :ref="element => inputs.push(element)"
                        :value="props.dataForUpdate.pro_name"
                        required="true"
                    />
                </div>
                <div>
                     <UIInputText 
                        ...
                        field="Dirección"
                        :ref="element => inputs.push(element)"
                        :value="props.dataForUpdate.pro_address"
                        required="false"
                    />
                </div>
                <div>
                     <UIInputText 
                        ...
                        field="Teléfono"
                        :ref="element => inputs.push(element)"
                        :value="props.dataForUpdate.pro_phone"
                        required="false"
                    />
                </div>
                <div>
                     <UIInputText 
                        ...
                        :ref="element => inputs.push(element)"
                        :value="props.dataForUpdate.pro_email"
                        required="false"
                    />
                </div>
                <div>
                    <UILocationPicker
                        ...
                        :modelValue="{ pro_country: props.dataForUpdate.pro_country, pro_state: props.dataForUpdate.pro_state, pro_city: props.dataForUpdate.pro_city }"
                        :ref="element => inputs.push(element)"
                        required="false"
                    />
                </div>
